...
This paper explores the consequences of considering reproduction not from the point of view of replicating a genome, but from the point of view of mapping an organism to another, with the genome as a constraint on the mapping function.
...
![A figure from the paper showing crazy-looking hand drawn chickens](images/chickens.png)


![A figure from the paper showing a hand drawn chicken and a long-spined frog](images/frog.png)
