# Preprint Review: Multicellular Reproduction Simulation

![Screenshot of a simulation: Several groups of cells against a pink
background](images/multicellular_01.jpg)
...
In their simulation, groups of cells forage in an environment. They
can move towards the gradient of a nearby food source or multiply, and
they can adhere to each other. The simulation does not have an
...
environments in the simulation: environment with less frequent food
sources encourage multicellular
strategies](images/multicellular_02.png)


A [thread on BlueSky by author Enrico Sandro
Colizzi](https://bsky.app/profile/escolizzi.bsky.social/post/3mgq5oe7ot22w)
describes the preprint in more detail, with several videos. Do take a
